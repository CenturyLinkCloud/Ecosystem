...
yum -y install gcc python-devel libxml2-devel libxslt-devel || (apt-get update && apt-get -y install gcc pip libxml2-dev libxslt1-dev python-dev python-dev libxslt1-dev python-lxml)
